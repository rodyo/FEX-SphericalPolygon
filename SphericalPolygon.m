classdef SphericalPolygon < handle
    ...
    methods
        ...
        function obj = SphericalPolygon(varargin)
        ...
        function A = get.area(obj)
            A = obj.sphereRadius^2 * (sum(obj.internalAngles) - (obj.N-2)*pi); end
        ...
        function ie = isempty(obj)
            ie = isempty(obj.vertexCoordinates); end
